...
export const ui: UiDictionary = {
  meta: {
    title: "Anatomiq — учить анатомию как художник",
    description:
    ...
    ogTitle: "Anatomiq — учить анатомию как художник",
    ogDescription: "Изучайте анатомию как художник — на подробных трёхмерных препаратах.",
    imageAlt: "Анатомический препарат сердца, парящий над подставкой, рядом с логотипом Anatomiq",
  },
  brand: { tagline: "Учить анатомию как художник", home: "Главная страница Anatomiq" },
